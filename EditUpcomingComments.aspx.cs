...
public partial class EditUpcomingComments : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        linkToDB.Open();
        string sqlText = @"SELECT [Comment] FROM [Upcoming_Comments] WHERE [id] = @id";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ReviewUpdate.UpdateCommand = "UPDATE [Upcoming_Comments] SET [Comment] = @Comment WHERE (id = @Id)";
